...
public class AllEmployeeInfo implements ActionListener 
{
	...
	public AllEmployeeInfo() 
	{
        ...
        JLabel title=new JLabel("Employee Info");
...
//...........Adding Employee info from database to JPanel..........................
        ...
        try
        {
        	...
        	Vector rows = null;
        	String str="select * from HotelEmployees";
			...
			if(com1.getSelectedItem()!="")
			{
				...
				try
			    {
					...
					Vector rows = null;
			       	...
			       	str="select * from HotelEmployees where EMPID='"+com1.getSelectedItem()+"'";
			...
			else
			{
				...
				try
			    {
					...
					Vector rows = null;
			       	...
			       	str="select * from HotelEmployees where JOB='"+com2.getSelectedItem()+"'";
