...
//...........Adding Employee info from database to JPanel..........................
        ...
        try
        {
        	...
        	Vector rows = null;
        	String str="select * from HotelRooms";
			...
			if(com1.getSelectedItem()!="")
			{
				...
				try
				{
			        ...
			        if(com2.getSelectedItem()!="")
			        {
			        	if(chk1.isSelected())
			        	{
			        		str="select * from HotelRooms where Room_Type='"+com1.getSelectedItem()+"' AND AVAILABILITY='Available' AND BED_TYPE='"+com2.getSelectedItem()+"'";
			        	}
			        	else
			        	{
			        		str="select * from HotelRooms where Room_Type='"+com1.getSelectedItem()+"'AND BED_TYPE='"+com2.getSelectedItem()+"'";
			        	}
			        }
			        else
			        {
			        	if(chk1.isSelected())
			        	{
			        		str="select * from HotelRooms where Room_Type='"+com1.getSelectedItem()+"' AND AVAILABILITY='Available'";
			        	}
			        	else
			        	{
			        		str="select * from HotelRooms where Room_Type='"+com1.getSelectedItem()+"'";
			        	}
			        }
			...
			else
			{
				...
				try
				{
			        ...
			        if(com2.getSelectedItem()!="")
			        {
			        	if(chk1.isSelected())
			        	{
			        		str="select * from HotelRooms AVAILABILITY='Available' AND BED_TYPE='"+com2.getSelectedItem()+"'";
			        	}
			        	else
			        	{
			        		str="select * from HotelRooms where BED_TYPE='"+com2.getSelectedItem()+"'";
			        	}
			        }
			        else
			        {
			        	if(chk1.isSelected())
			        	{
			        		str="select * from HotelRooms where AVAILABILITY='Available'";
			        	}
			        	else
			        	{
			        		panelForJTable1.setVisible(false);
